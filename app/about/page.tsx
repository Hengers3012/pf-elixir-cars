...
import person_4 from "../../public/Image/person-4.png";
import person_5 from "../../public/Image/person-5.png";
import person_6 from "../../public/Image/person-6.png";
                ...
                <div className="p-4 lg:w-1/3 md:w-1/2 w-full ">
                  <div className="h-full flex items-top border-gray-200 border p-2 rounded-lg transition duration-300 hover:shadow-md shadow-[#555555] hover:bg-[#FFD700]">
                    ...
                    <div className="flex-grow sm:pl-4 pl-2">
                      ...
                      <h3 className="text-gray-500 mb-3">Product Owner</h3>
                ...
                <div className="p-4 lg:w-1/3 md:w-1/2 w-full ">
                  <div className="h-full flex items-top border-gray-200 border p-2 rounded-lg transition duration-300 hover:shadow-md shadow-[#555555] hover:bg-[#FFD700]">
                    <div className="flex-grow max-w-fit sm:pl-2 sm:pt-2 ">
                      <Image
                        alt="team"
                        className=" mr-2 flex-shrink-0 h-32 w-32 bg-white rounded-lg object-cover object-top sm:mb-0 border-solid shadow-md shadow-[#555555] transition duration-500 hover:scale-105"
                        src={person_4}
                        width={"500"}
                      />
                    </div>
